...
a = conn.Create('a', weak=True)
a.SetProperty('cpu_set', 'jail 3; node 0')
a.Start()

assert a['cpu_set'] == 'jail 3; node 0'
a.SetProperty('cpu_set', 'jail 3; node 0')
assert a['cpu_set'] == 'jail 3; node 0'

if CPUNR == 4:
    assert a['cpu_set_affinity'] == '0,2-3'
elif CPUNR >= 4:
    assert a['cpu_set_affinity'] == '2-4'
...
a.SetProperty('cpu_set', 'jail 1; node 0')
assert a['cpu_set'] == 'jail 1; node 0'
