...
ExpectProp(e, 'memory_limit', str(def_limit))
ExpectProp(e, 'memory_limit_total', str(def_limit))
ExpectProp(e, 'anon_limit', str(def_anon))
ExpectProp(e, 'anon_limit_total', str(def_anon))
